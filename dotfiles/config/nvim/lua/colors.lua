...
vim.api.nvim_set_hl(0, "CursorLine", { bg=color("ui_3_12") })
vim.api.nvim_set_hl(0, "CursorLineNr", { bg=color("ui_3_12"), fg=color("gray") })
...
-- focused
vim.api.nvim_set_hl(0, "StatusLine", { bg=color("ui_2_12"), fg=color("bright_gray") })
vim.api.nvim_set_hl(0, "User1", { bg=color("ui_2_12"), fg=color("bright_yellow") })
-- not focused
vim.api.nvim_set_hl(0, "StatusLineNC", { bg=color("ui_1_10"), fg=color("gray") })
vim.api.nvim_set_hl(0, "User2", { bg=color("ui_1_10"), fg=color("gray") })
