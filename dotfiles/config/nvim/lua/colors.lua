...
vim.api.nvim_set_hl(0, "CursorLine", { bg=color("gray_10") })
vim.api.nvim_set_hl(0, "CursorLineNr", { bg=color("gray_10"), fg=color("gray") })
...
-- focused
vim.api.nvim_set_hl(0, "StatusLine", { bg=color("ui_2_10"), fg=color("bright_gray") })
vim.api.nvim_set_hl(0, "User1", { bg=color("ui_2_10"), fg=color("bright_yellow") })
-- not focused
